        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: true),
                    Url = table.Column<string>(nullable: true),
                    LeftNavId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeftNavItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LeftNavItems_LeftNavs_LeftNavId",
                        column: x => x.LeftNavId,
                        principalTable: "LeftNavs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeftNavItems_LeftNavId",
                table: "LeftNavItems",
                column: "LeftNavId");
        }
